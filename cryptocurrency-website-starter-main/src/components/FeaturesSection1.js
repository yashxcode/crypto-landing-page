      ...
      <div className="flex flex-col lg:flex-row">
        ...
        data-aos="fade-right" data-aos-offset="400">
          ...
          <p className="text-gray mb-8">
            Get full statistic information about the behavior of 
            buyers and sellers, which will help you make the right decision.
          </p>
          <button className="btn px-8">Learn more</button>
        </div>
        <div className="flex flex-1 justify-end" 
        data-aos="fade-left" data-aos-offset="400">
          <img src={Image1} alt="Statistical Information" />
        </div>
      </div>
    </section>
  )
